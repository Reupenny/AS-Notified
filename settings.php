...
function Better_Notified_settings_page()
{
    ...
    $Better_Notified_bot_token = get_option('Better_Notified_bot_token');
    $Better_Notified_chat_id = get_option('Better_Notified_chat_id');
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                <tbody>
                    <tr>
                        <th scope="row">
                            <label for="Better_Notified_bot_token"><?php esc_html_e('Telegram Bot Token', 'telegram-admin-emails'); ?></label>
                        </th>
                        <td>
                            <input name="Better_Notified_bot_token" type="text" id="Better_Notified_bot_token" value="<?php
                                                                                                                        echo esc_attr($Better_Notified_bot_token); ?>" class="regular-text">
                            <p class="description" id="Better_Notified_bot_token-description">
                    ...
                    <tr>
                        <th scope="row">
                            <label for="Better_Notified_chat_id"><?php esc_html_e('Telegram Chat ID', 'telegram-admin-emails'); ?></label>
                        </th>
                        <td>
                            <input name="Better_Notified_chat_id" type="text" id="Better_Notified_chat_id" value="<?php echo esc_attr($Better_Notified_chat_id); ?>" class="regular-text">
                            <p class="description" id="Better_Notified_chat_id-description">
